...
Instead, creating a distributed system which gives any of the devices the power and control to communicate with each other, relieves the network of a single point of failure and can help spread the load across the network.
%Heavy weight Java
%Centralised
