...
\begin{enumerate}
	...
	\item Configuration of device attributes, such as name, type, freq
...
\begin{itemize}
	...
	\item Network reliability of only essential communications
...
\begin{itemize}
	\item The system must be designed and developed within a limited time frame, 20ish weeks
	\item Choice of devices is based on the availability of constrained devices between the School of Computing the student, therefore the use of TelosB motes is imperative.
