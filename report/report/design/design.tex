...
The protocol header contains a minimal set of data fields, to reduce the strain on the network, which are essential for ensuring identifying channels, distinguishing message types and ensuring the integrity of the data sent.
