...
Lastly, because CoAP is so similar to HTTP in the commands that it uses (GET, PUT, DELETE, etc.), it makes it simple translate messages between protocols, and therefore allow these constrained devices to send and receive data to and from the WWW.\cite{IETF_COAP_HTTP} 
